...
defmodule Blitzy.CLI do
	...
	results
	  ...
	  total_success = Enum.count(succcesses)
	  total_failure = total_workers - total_success

	  data = succcesses |> Enum.map(fn {:ok, time} -> time end)
	...
	defp do_help do
		...
		Example:
		./blitzy -n 100 http://someting.com
		"""
		System.halt(0)
	end
end